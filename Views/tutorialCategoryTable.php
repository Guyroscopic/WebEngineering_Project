...
<body>
	...
	<?php if(@$_GET["added"]){ ?>
        <div class="flashMsgGreen">Tutorial Category Added Successfuly!</div>
    <?php } ?>

    <?php if(@$_GET["success"]){ ?>
		<div class="flashMsgGreen">Tutorial Category Deleted Successfully!</div>
	<?php } ?>

	<h1><span class="multi-text">Manage Tutorial Categories</span></h1>

	<!-- Anchor tag for adding a student -->
	<h2><span id="add" class="fa fa-plus-circle">&nbsp;<a href="addTutorialCategory.php">Add a Tutorial Category</a></span></h2><br><br>
