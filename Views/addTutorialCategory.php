...
<body> 
	...
	<div class="main">
	<h1><span class="multi-text">Add Tutorial Category</h1><br>

	<?php if(@$_GET["empty"]){ ?>
        <div class="flashMsgRed">OOPS! Looks like you left a field empty</div>
    <?php } ?>

	<form class="form-horizontal" action="../Controllers/AddTutorialCategoryController.php" method="POST">
		<div class="form-group row"> 
		<label class="col-sm-2 col-form-label col-form-label">Name of Category</label>
		<div class="col-sm-8">
		<input class="form-control form-control"type="text" name="categoryName" placeholder="Enter Category Name" required>
	    <br><br>
	</div></div>

	    <button class="btn btn-info" name="add">Add Category</button>
