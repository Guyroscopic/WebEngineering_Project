...
<body>
	...
	<?php if(@$_GET["success"]){ ?>
		<div class="flashMsgGreen">Question Deleted Successfully!</div>
	<?php } ?>

	<h1><span class="multi-text">Manage Question Database</span></h1>
	...
	<table class="container">
		...
		<tr>
			...
			<td><a href='../Controllers/DeleteController.php?table=question&id=<?php echo $row["id"] ?>'>Delete</a></td>
		</tr>
		<?php } ?>
	</table>
