...
<body>
    ...
    <div class="main">
	<h1><span class="multi-text">Add Admin</span></h1>
	...
	<form class="form-horizontal" action="../Controllers/AddAdminController.php" method="POST">
		...
		<div class="col-sm-8">
		<input class="form-control form-control" type="text" name="username" placeholder="Enter Username" required>
		</div></div>
	    <br><br>
	    ...
	    <div class="col-sm-8">
		<input class="form-control form-control" type="text" name="email" placeholder="Enter Email ID" required>
		</div></div>
	    <br><br>
	    ...
	    <div class="col-sm-8">
	    <input class="form-control form-control" type="text" name="password" placeholder="Enter Password" required>
	    </div></div>
	    <br><br>
