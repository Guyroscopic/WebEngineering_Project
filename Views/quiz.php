<?php	
	...
	// fetching the quiz topic and initializing global variables
	...
	<?php
		...
		if($student_loggedin){
			...
			while($question = mysqli_fetch_assoc($quiz_question)){
				...
				$quiz_form .= "<br><input type='radio' name='". $question_num. "' value='". $option1."'><label>".$option1."</label><br>";
				$quiz_form .= "<input type='radio' name='". $question_num. "' value='". $option2."'><label>".$option2."</label><br>";
